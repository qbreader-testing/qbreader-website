import{downloadQuestionsAsText,downloadBonusesAsCSV,downloadTossupsAsCSV,downloadQuestionsAsJSON}from"./download.js";import{highlightBonusQuery,highlightTossupQuery}from"./highlight-query.js";import api from"../scripts/api/index.js";import star from"../scripts/auth/star.js";import TossupCard from"./TossupCard.min.js";import BonusCard from"./BonusCard.min.js";import CategoryModal from"../scripts/components/CategoryModal.min.js";import DifficultyDropdown from"../scripts/components/DifficultyDropdown.min.js";import Star from"../scripts/components/Star.min.js";import{getDropdownValues,setDropdownValues}from"../scripts/utilities/dropdown-checklist.js";import filterParams from"../scripts/utilities/filter-params.js";import CategoryManager from"../../quizbowl/category-manager.js";const starredTossupIds=new Set(await star.getStarredTossupIds()),starredBonusIds=new Set(await star.getStarredBonusIds()),fontSize="true"===window.localStorage.getItem("database-font-size")?window.localStorage.getItem("font-size")??16:16,paginationShiftLength=992<window.screen.width?10:5,categoryManager=new CategoryManager;function arrayBetween(a,b){return Array(b-a).fill().map((b,c)=>a+c)}function QueryForm(){function a(){return Math.floor(1e4/(u||25))}/**
   *
